...
namespace AutoStack.Infrastructure.Migrations
{
    ...
    [Migration("20251215144045_FixConcurrencyAndFKConstraints")]
    partial class FixConcurrencyAndFKConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoStack.Domain.Entities.StackVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AutoStack.Domain.Entities.RecoveryCode", b =>
                {
                    b.HasOne("AutoStack.Domain.Entities.User", null)
                        .WithMany()
